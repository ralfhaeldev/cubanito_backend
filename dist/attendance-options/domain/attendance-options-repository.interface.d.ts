...
export declare abstract class AttendanceOptionsRepository<T> {
    abstract create(createAttendanceOptionDto: CreateAttendanceOptionDto): Promise<T>;
    abstract update(id: string, updateAttendanceOptionDto: UpdateAttendanceOptionDto): Promise<T>;
